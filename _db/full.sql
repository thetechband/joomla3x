...
-- Dumping structure for table joomla.zro8d_assets
CREATE TABLE IF NOT EXISTS `zro8d_assets` (
...
-- Dumping data for table joomla.zro8d_assets: ~47 rows (approximately)
/*!40000 ALTER TABLE `zro8d_assets` DISABLE KEYS */;
INSERT INTO `zro8d_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
	...
	(25, 1, 71, 76, 1, 'com_weblinks', 'com_weblinks', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
	...
	(34, 25, 74, 75, 2, 'com_weblinks.category.8', 'Blog Roll', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
	(35, 8, 24, 33, 2, 'com_content.category.9', 'Blog', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
	(36, 27, 19, 20, 3, 'com_content.article.1', 'Về chúng tôi', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
/*!40000 ALTER TABLE `zro8d_assets` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_associations
CREATE TABLE IF NOT EXISTS `zro8d_associations` (
...
-- Dumping data for table joomla.zro8d_associations: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_associations` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_associations` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_banners
CREATE TABLE IF NOT EXISTS `zro8d_banners` (
...
-- Dumping data for table joomla.zro8d_banners: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_banners` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_banners` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_banner_clients
CREATE TABLE IF NOT EXISTS `zro8d_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
-- Dumping data for table joomla.zro8d_banner_clients: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_banner_clients` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_banner_clients` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_banner_tracks
CREATE TABLE IF NOT EXISTS `zro8d_banner_tracks` (
...
-- Dumping data for table joomla.zro8d_banner_tracks: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_banner_tracks` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_banner_tracks` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_categories
CREATE TABLE IF NOT EXISTS `zro8d_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_categories: ~9 rows (approximately)
/*!40000 ALTER TABLE `zro8d_categories` DISABLE KEYS */;
INSERT INTO `zro8d_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
	(1, 0, 0, 0, 17, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(6, 31, 1, 9, 10, 1, 'uncategorised', 'com_weblinks', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 867, '2011-01-01 00:00:01', 363, '2012-07-20 19:31:28', 0, '*', 1),
	(7, 32, 1, 11, 12, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
	(8, 42, 1, 13, 14, 1, 'blog-roll', 'com_weblinks', 'Blog Roll', 'blog-roll', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 867, '2011-01-01 00:00:01', 363, '2012-07-20 19:44:04', 0, '*', 1),
	(9, 35, 1, 15, 16, 1, 'blog', 'com_content', 'Blog', 'blog', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 867, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);
/*!40000 ALTER TABLE `zro8d_categories` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_contact_details
CREATE TABLE IF NOT EXISTS `zro8d_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
-- Dumping data for table joomla.zro8d_contact_details: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_contact_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_contact_details` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_content
CREATE TABLE IF NOT EXISTS `zro8d_content` (
...
-- Dumping data for table joomla.zro8d_contentitem_tag_map: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_contentitem_tag_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_contentitem_tag_map` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_content_frontpage
CREATE TABLE IF NOT EXISTS `zro8d_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table joomla.zro8d_content_frontpage: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_content_frontpage` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_content_frontpage` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_content_rating
CREATE TABLE IF NOT EXISTS `zro8d_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table joomla.zro8d_content_rating: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_content_rating` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_content_rating` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_content_types
CREATE TABLE IF NOT EXISTS `zro8d_content_types` (
...
-- Dumping data for table joomla.zro8d_content_types: ~31 rows (approximately)
/*!40000 ALTER TABLE `zro8d_content_types` DISABLE KEYS */;
INSERT INTO `zro8d_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
/*!40000 ALTER TABLE `zro8d_content_types` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_core_log_searches
CREATE TABLE IF NOT EXISTS `zro8d_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table joomla.zro8d_core_log_searches: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_core_log_searches` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_core_log_searches` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_extensions
CREATE TABLE IF NOT EXISTS `zro8d_extensions` (
...
-- Dumping data for table joomla.zro8d_extensions: ~139 rows (approximately)
/*!40000 ALTER TABLE `zro8d_extensions` DISABLE KEYS */;
INSERT INTO `zro8d_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
	...
	(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"75c098589bc66355a5832b5b9942fc5f"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
/*!40000 ALTER TABLE `zro8d_extensions` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_filters
CREATE TABLE IF NOT EXISTS `zro8d_finder_filters` (
...
-- Dumping data for table joomla.zro8d_finder_filters: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_filters` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_filters` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links
CREATE TABLE IF NOT EXISTS `zro8d_finder_links` (
...
-- Dumping data for table joomla.zro8d_finder_links: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms0
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms0` (
...
-- Dumping data for table joomla.zro8d_finder_links_terms0: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms0` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms0` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms1
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms1: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms1` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms1` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms2
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms2: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms2` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms2` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms3
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms3: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms3` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms3` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms4
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms4: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms4` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms4` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms5
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms5: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms5` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms5` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms6
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms6: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms6` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms6` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms7
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms7: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms7` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms7` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms8
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms8: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms8` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms8` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_terms9
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_terms9: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_terms9` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_terms9` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_termsa
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_termsa: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_termsa` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_termsa` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_termsb
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_termsb: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_termsb` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_termsb` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_termsc
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_termsc: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_termsc` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_termsc` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_termsd
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_termsd: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_termsd` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_termsd` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_termse
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_termse: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_termse` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_termse` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_links_termsf
CREATE TABLE IF NOT EXISTS `zro8d_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
-- Dumping data for table joomla.zro8d_finder_links_termsf: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_links_termsf` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_links_termsf` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_taxonomy
CREATE TABLE IF NOT EXISTS `zro8d_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
-- Dumping data for table joomla.zro8d_finder_taxonomy: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_taxonomy` DISABLE KEYS */;
INSERT INTO `zro8d_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
	(1, 0, 'ROOT', 0, 0, 0);
/*!40000 ALTER TABLE `zro8d_finder_taxonomy` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_taxonomy_map
CREATE TABLE IF NOT EXISTS `zro8d_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
-- Dumping data for table joomla.zro8d_finder_taxonomy_map: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_taxonomy_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_taxonomy_map` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_terms
CREATE TABLE IF NOT EXISTS `zro8d_finder_terms` (
...
-- Dumping data for table joomla.zro8d_finder_terms: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_terms` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_terms_common
CREATE TABLE IF NOT EXISTS `zro8d_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
-- Dumping data for table joomla.zro8d_finder_terms_common: ~115 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_terms_common` DISABLE KEYS */;
INSERT INTO `zro8d_finder_terms_common` (`term`, `language`) VALUES
	('a', 'en'),
	('about', 'en'),
	('after', 'en'),
	('ago', 'en'),
	...
	('your', 'en'),
	('yours', 'en');
/*!40000 ALTER TABLE `zro8d_finder_terms_common` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_tokens
CREATE TABLE IF NOT EXISTS `zro8d_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
-- Dumping data for table joomla.zro8d_finder_tokens: 0 rows
/*!40000 ALTER TABLE `zro8d_finder_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_tokens` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_tokens_aggregate
CREATE TABLE IF NOT EXISTS `zro8d_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
-- Dumping data for table joomla.zro8d_finder_tokens_aggregate: 0 rows
/*!40000 ALTER TABLE `zro8d_finder_tokens_aggregate` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_tokens_aggregate` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_finder_types
CREATE TABLE IF NOT EXISTS `zro8d_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_finder_types: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_finder_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_finder_types` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_languages
CREATE TABLE IF NOT EXISTS `zro8d_languages` (
...
-- Dumping data for table joomla.zro8d_languages: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_languages` DISABLE KEYS */;
INSERT INTO `zro8d_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
	(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);
/*!40000 ALTER TABLE `zro8d_languages` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_menu
CREATE TABLE IF NOT EXISTS `zro8d_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_menu: ~37 rows (approximately)
/*!40000 ALTER TABLE `zro8d_menu` DISABLE KEYS */;
INSERT INTO `zro8d_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
	...
	(105, 'authormenu', 'Add to Blog Roll', 'add-to-blog-roll', '', 'edit-blog-roll/add-to-blog-roll', 'index.php?option=com_weblinks&view=form&layout=edit', 'component', 1, 110, 2, 21, 0, '0000-00-00 00:00:00', 0, 3, '', 0, '{"menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 14, 15, 0, '*', 0),
	...
	(108, 'mainmenu', 'Về chúng tôi', 've-chung-toi', '', 've-chung-toi', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"0","show_category":"0","link_category":"0","show_parent_category":"","link_parent_category":"","show_author":"0","link_author":"","show_create_date":"0","show_modify_date":"","show_publish_date":"0","show_item_navigation":"","show_vote":"","show_tags":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"0","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 31, 32, 0, '*', 0),
...
/*!40000 ALTER TABLE `zro8d_menu` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_menu_types
CREATE TABLE IF NOT EXISTS `zro8d_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_menu_types: ~3 rows (approximately)
/*!40000 ALTER TABLE `zro8d_menu_types` DISABLE KEYS */;
INSERT INTO `zro8d_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
	(1, 'mainmenu', 'Main Menu', 'The main menu for the site'),
	(2, 'authormenu', 'Author Menu', ''),
	(3, 'bottommenu', 'Bottom Menu', '');
/*!40000 ALTER TABLE `zro8d_menu_types` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_messages
CREATE TABLE IF NOT EXISTS `zro8d_messages` (
...
-- Dumping data for table joomla.zro8d_messages: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_messages` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_messages_cfg
CREATE TABLE IF NOT EXISTS `zro8d_messages_cfg` (
...
-- Dumping data for table joomla.zro8d_messages_cfg: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_messages_cfg` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_messages_cfg` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_modules
CREATE TABLE IF NOT EXISTS `zro8d_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
-- Dumping data for table joomla.zro8d_modules: ~27 rows (approximately)
/*!40000 ALTER TABLE `zro8d_modules` DISABLE KEYS */;
INSERT INTO `zro8d_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
	...
	(81, 0, 'Blog Roll', '', '', 3, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_weblinks', 1, 1, '{"catid":"8","count":"5","ordering":"title","direction":"asc","target":"1","description":"0","hits":"0","count_clicks":"0","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
...
/*!40000 ALTER TABLE `zro8d_modules` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_modules_menu
CREATE TABLE IF NOT EXISTS `zro8d_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table joomla.zro8d_modules_menu: ~29 rows (approximately)
/*!40000 ALTER TABLE `zro8d_modules_menu` DISABLE KEYS */;
INSERT INTO `zro8d_modules_menu` (`moduleid`, `menuid`) VALUES
	(1, 0),
	(2, 0),
	(3, 0),
	(4, 0),
	...
	(91, 0),
	(92, 0);
/*!40000 ALTER TABLE `zro8d_modules_menu` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_newsfeeds
CREATE TABLE IF NOT EXISTS `zro8d_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_newsfeeds: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_newsfeeds` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_newsfeeds` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_overrider
CREATE TABLE IF NOT EXISTS `zro8d_overrider` (
...
-- Dumping data for table joomla.zro8d_overrider: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_overrider` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_overrider` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_postinstall_messages
CREATE TABLE IF NOT EXISTS `zro8d_postinstall_messages` (
...
-- Dumping data for table joomla.zro8d_postinstall_messages: 4 rows
/*!40000 ALTER TABLE `zro8d_postinstall_messages` DISABLE KEYS */;
INSERT INTO `zro8d_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
/*!40000 ALTER TABLE `zro8d_postinstall_messages` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_redirect_links
CREATE TABLE IF NOT EXISTS `zro8d_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_redirect_links: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_redirect_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_redirect_links` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_schemas
CREATE TABLE IF NOT EXISTS `zro8d_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table joomla.zro8d_schemas: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_schemas` DISABLE KEYS */;
INSERT INTO `zro8d_schemas` (`extension_id`, `version_id`) VALUES
	(700, '3.2.3-2014-02-20');
/*!40000 ALTER TABLE `zro8d_schemas` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_session
CREATE TABLE IF NOT EXISTS `zro8d_session` (
...
-- Dumping data for table joomla.zro8d_session: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_session` DISABLE KEYS */;
INSERT INTO `zro8d_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
	('32r4j78cgqjc34vhegvmp96st5', 0, 1, '1398609206', '__default|a:9:{s:15:"session.counter";i:10;s:19:"session.timer.start";i:1398608908;s:18:"session.timer.last";i:1398609202;s:17:"session.timer.now";i:1398609206;s:22:"session.client.browser";s:139:"Mozilla/5.0 (X11; Linux i686) AppleWebKit/535.19 (KHTML, like Gecko) Ubuntu/11.04 Chromium/18.0.1025.151 Chrome/18.0.1025.151 Safari/535.19";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":1:{s:5:"users";O:8:"stdClass":1:{s:5:"login";O:8:"stdClass":1:{s:4:"form";O:8:"stdClass":1:{s:4:"data";a:1:{s:6:"return";s:39:"index.php?option=com_users&view=profile";}}}}}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:6:{s:40:"4a413d94fb1da30246be7f0e55f55ed0a9c230f6";O:8:"stdClass":2:{s:4:"link";s:39:"http://localhost/joomla/index.php/about";s:6:"expiry";i:1398608940;}s:40:"fb3e16a6ce840b26266947bcd58a404912b5f188";O:8:"stdClass":2:{s:4:"link";s:56:"http://localhost/joomla/index.php/3-welcome-to-your-blog";s:6:"expiry";i:1398609206;}s:40:"6f2375208dc915f38d4ba885d5f20da23a7f54df";O:8:"stdClass":2:{s:4:"link";s:56:"http://localhost/joomla/index.php/4-about-your-home-page";s:6:"expiry";i:1398609206;}s:40:"41340651db561d284ff11df2f97f8efc5b21c4d5";O:8:"stdClass":2:{s:4:"link";s:49:"http://localhost/joomla/index.php/6-your-template";s:6:"expiry";i:1398609206;}s:40:"b42aca45dec2eb2beaae3572b8489175f721a44e";O:8:"stdClass":2:{s:4:"link";s:48:"http://localhost/joomla/index.php/5-your-modules";s:6:"expiry";i:1398609206;}s:40:"7c3994ab75db2c2a257c108b98c97f533a646e4b";O:8:"stdClass":2:{s:4:"link";s:46:"http://localhost/joomla/index.php/ve-chung-toi";s:6:"expiry";i:1398609033;}}s:13:"session.token";s:32:"4bbd217e131ea6ef3e3cf0355e3cae4d";}', 0, ''),
	('ockh7hq74bbaq5d47tasggd7h2', 1, 0, '1398609029', '__default|a:8:{s:15:"session.counter";i:60;s:19:"session.timer.start";i:1398602973;s:18:"session.timer.last";i:1398609028;s:17:"session.timer.now";i:1398609028;s:22:"session.client.browser";s:74:"Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:16.0) Gecko/20100101 Firefox/16.0";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":5:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:11:"com_content";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":3:{s:8:"menutype";s:8:"mainmenu";s:10:"limitstart";i:0;s:4:"list";a:4:{s:9:"direction";s:3:"asc";s:5:"limit";s:2:"20";s:8:"ordering";s:5:"a.lft";s:5:"start";d:0;}}s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":4:{s:2:"id";a:1:{i:0;i:108;}s:4:"data";N;s:4:"type";N;s:4:"link";N;}}}s:13:"com_templates";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:5:"style";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"867";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:17:"vietean@gmail.com";s:8:"password";s:34:"$P$DKAisCTZflH1XlZeaBJDrZUfuFz64v0";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2014-04-27 12:46:40";s:13:"lastvisitDate";s:19:"2014-04-27 12:49:17";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"8665c8b876db3c6b86881ebb7b2a6dc8";}', 867, 'admin');
/*!40000 ALTER TABLE `zro8d_session` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_tags
CREATE TABLE IF NOT EXISTS `zro8d_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table joomla.zro8d_tags: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_tags` DISABLE KEYS */;
INSERT INTO `zro8d_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
	(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 867, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `zro8d_tags` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_template_styles
CREATE TABLE IF NOT EXISTS `zro8d_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_template_styles: ~4 rows (approximately)
/*!40000 ALTER TABLE `zro8d_template_styles` DISABLE KEYS */;
INSERT INTO `zro8d_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
	(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
	(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
	(7, 'protostar', 0, '1', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
	(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}');
/*!40000 ALTER TABLE `zro8d_template_styles` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_ucm_base
CREATE TABLE IF NOT EXISTS `zro8d_ucm_base` (
...
-- Dumping data for table joomla.zro8d_ucm_base: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_ucm_base` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_ucm_base` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_ucm_content
CREATE TABLE IF NOT EXISTS `zro8d_ucm_content` (
...
-- Dumping data for table joomla.zro8d_ucm_content: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_ucm_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_ucm_content` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_ucm_history
CREATE TABLE IF NOT EXISTS `zro8d_ucm_history` (
...
-- Dumping data for table joomla.zro8d_ucm_history: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_ucm_history` DISABLE KEYS */;
INSERT INTO `zro8d_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
	(1, 1, 1, '', '2014-04-27 12:50:40', 867, 1824, '4717d0c43528cbf5c4ece2a8696d79638e3d193b', '{"id":1,"asset_id":"36","title":"About","alias":"about","introtext":"<p>Ch\\u00fang t\\u00f4i mu\\u1ed1n cung c\\u1ea5p cho b\\u1ea1n c\\u00e1ch nhanh nh\\u1ea5t \\u0111\\u1ec3 t\\u00ecm \\u0111\\u1ecba ch\\u1ec9 \\u0103n chay<\\/p>","fulltext":"","state":1,"catid":"2","created":"2011-01-01 00:00:01","created_by":"867","created_by_alias":"Joomla","modified":"2014-04-27 12:50:40","modified_by":"867","checked_out":"867","checked_out_time":"2014-04-27 12:49:45","publish_up":"2012-01-04 16:10:42","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"16","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
	(2, 1, 1, '', '2014-04-27 14:28:26', 867, 1846, 'a28f5a418bd3f61b4d830833599190a0400bc61c', '{"id":1,"asset_id":"36","title":"V\\u1ec1 ch\\u00fang t\\u00f4i","alias":"about","introtext":"<p>Ch\\u00fang t\\u00f4i mu\\u1ed1n cung c\\u1ea5p cho b\\u1ea1n c\\u00e1ch nhanh nh\\u1ea5t \\u0111\\u1ec3 t\\u00ecm \\u0111\\u1ecba ch\\u1ec9 \\u0103n chay<\\/p>","fulltext":"","state":1,"catid":"2","created":"2011-01-01 00:00:01","created_by":"867","created_by_alias":"Joomla","modified":"2014-04-27 14:28:26","modified_by":"867","checked_out":"867","checked_out_time":"2014-04-27 14:27:08","publish_up":"2012-01-04 16:10:42","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"18","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
	(3, 1, 1, '', '2014-04-27 14:28:43', 867, 1852, '47fb4bdccc3c1211acd503a438ba269f7f9bbe70', '{"id":1,"asset_id":"36","title":"V\\u1ec1 ch\\u00fang t\\u00f4i","alias":"v-chung-toi","introtext":"<p>Ch\\u00fang t\\u00f4i mu\\u1ed1n cung c\\u1ea5p cho b\\u1ea1n c\\u00e1ch nhanh nh\\u1ea5t \\u0111\\u1ec3 t\\u00ecm \\u0111\\u1ecba ch\\u1ec9 \\u0103n chay<\\/p>","fulltext":"","state":1,"catid":"2","created":"2011-01-01 00:00:01","created_by":"867","created_by_alias":"Joomla","modified":"2014-04-27 14:28:43","modified_by":"867","checked_out":"867","checked_out_time":"2014-04-27 14:28:26","publish_up":"2012-01-04 16:10:42","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":4,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"20","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
	(4, 1, 1, '', '2014-04-27 14:28:55', 867, 1853, '8d772bc6932e18538099fb9172e5989421ce3516', '{"id":1,"asset_id":"36","title":"V\\u1ec1 ch\\u00fang t\\u00f4i","alias":"ve-chung-toi","introtext":"<p>Ch\\u00fang t\\u00f4i mu\\u1ed1n cung c\\u1ea5p cho b\\u1ea1n c\\u00e1ch nhanh nh\\u1ea5t \\u0111\\u1ec3 t\\u00ecm \\u0111\\u1ecba ch\\u1ec9 \\u0103n chay<\\/p>","fulltext":"","state":1,"catid":"2","created":"2011-01-01 00:00:01","created_by":"867","created_by_alias":"Joomla","modified":"2014-04-27 14:28:55","modified_by":"867","checked_out":"867","checked_out_time":"2014-04-27 14:28:43","publish_up":"2012-01-04 16:10:42","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":5,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"20","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);
/*!40000 ALTER TABLE `zro8d_ucm_history` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_updates
CREATE TABLE IF NOT EXISTS `zro8d_updates` (
...
-- Dumping data for table joomla.zro8d_updates: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_updates` DISABLE KEYS */;
INSERT INTO `zro8d_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
/*!40000 ALTER TABLE `zro8d_updates` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_update_sites
CREATE TABLE IF NOT EXISTS `zro8d_update_sites` (
...
-- Dumping data for table joomla.zro8d_update_sites: ~3 rows (approximately)
/*!40000 ALTER TABLE `zro8d_update_sites` DISABLE KEYS */;
INSERT INTO `zro8d_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
	(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1398608769, ''),
	(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1398608769, ''),
	(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1398608767, '');
/*!40000 ALTER TABLE `zro8d_update_sites` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_update_sites_extensions
CREATE TABLE IF NOT EXISTS `zro8d_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

-- Dumping data for table joomla.zro8d_update_sites_extensions: ~3 rows (approximately)
/*!40000 ALTER TABLE `zro8d_update_sites_extensions` DISABLE KEYS */;
INSERT INTO `zro8d_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
	(1, 700),
	(2, 700),
	(3, 600);
/*!40000 ALTER TABLE `zro8d_update_sites_extensions` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_usergroups
CREATE TABLE IF NOT EXISTS `zro8d_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
-- Dumping data for table joomla.zro8d_usergroups: ~9 rows (approximately)
/*!40000 ALTER TABLE `zro8d_usergroups` DISABLE KEYS */;
INSERT INTO `zro8d_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
	(1, 0, 1, 18, 'Public'),
	(2, 1, 8, 15, 'Registered'),
	(3, 2, 9, 14, 'Author'),
	(4, 3, 10, 13, 'Editor'),
	...
	(9, 1, 2, 3, 'Guest');
/*!40000 ALTER TABLE `zro8d_usergroups` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_users
CREATE TABLE IF NOT EXISTS `zro8d_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
-- Dumping data for table joomla.zro8d_users: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_users` DISABLE KEYS */;
INSERT INTO `zro8d_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
	(867, 'Super User', 'admin', 'vietean@gmail.com', '$P$DKAisCTZflH1XlZeaBJDrZUfuFz64v0', 0, 1, '2014-04-27 12:46:40', '2014-04-27 12:49:39', '0', '', '0000-00-00 00:00:00', 0, '', '');
/*!40000 ALTER TABLE `zro8d_users` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_user_keys
CREATE TABLE IF NOT EXISTS `zro8d_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table joomla.zro8d_user_keys: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_user_keys` DISABLE KEYS */;
INSERT INTO `zro8d_user_keys` (`id`, `user_id`, `token`, `series`, `invalid`, `time`, `uastring`) VALUES
	(1, 'admin', '$P$DvfF9J5KAZQFfJoSG5N7rmgZ207LjY.', 'lmCuVXgE4WPkZ6eGymqt', 0, '1403786957', '94fc2ca88f277e6bfea7f6d3af91b1b5');
/*!40000 ALTER TABLE `zro8d_user_keys` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_user_notes
CREATE TABLE IF NOT EXISTS `zro8d_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
-- Dumping data for table joomla.zro8d_user_notes: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_user_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_user_notes` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_user_profiles
CREATE TABLE IF NOT EXISTS `zro8d_user_profiles` (
...
-- Dumping data for table joomla.zro8d_user_profiles: ~0 rows (approximately)
/*!40000 ALTER TABLE `zro8d_user_profiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `zro8d_user_profiles` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_user_usergroup_map
CREATE TABLE IF NOT EXISTS `zro8d_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table joomla.zro8d_user_usergroup_map: ~1 rows (approximately)
/*!40000 ALTER TABLE `zro8d_user_usergroup_map` DISABLE KEYS */;
INSERT INTO `zro8d_user_usergroup_map` (`user_id`, `group_id`) VALUES
	(867, 8);
/*!40000 ALTER TABLE `zro8d_user_usergroup_map` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_viewlevels
CREATE TABLE IF NOT EXISTS `zro8d_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
-- Dumping data for table joomla.zro8d_viewlevels: ~5 rows (approximately)
/*!40000 ALTER TABLE `zro8d_viewlevels` DISABLE KEYS */;
INSERT INTO `zro8d_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
	(1, 'Public', 0, '[1]'),
	(2, 'Registered', 1, '[6,2,8]'),
	(3, 'Special', 2, '[6,3,8]'),
	(5, 'Guest', 0, '[9]'),
	(6, 'Super Users', 0, '[8]');
/*!40000 ALTER TABLE `zro8d_viewlevels` ENABLE KEYS */;


-- Dumping structure for table joomla.zro8d_weblinks
CREATE TABLE IF NOT EXISTS `zro8d_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
-- Dumping data for table joomla.zro8d_weblinks: ~2 rows (approximately)
/*!40000 ALTER TABLE `zro8d_weblinks` DISABLE KEYS */;
INSERT INTO `zro8d_weblinks` (`id`, `catid`, `title`, `alias`, `url`, `description`, `hits`, `state`, `checked_out`, `checked_out_time`, `ordering`, `access`, `params`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `featured`, `xreference`, `publish_up`, `publish_down`, `version`, `images`) VALUES
	(1, 8, 'Joomla! Community', 'joomla-community', 'http://community.joomla.org/blogs/community.html', '', 0, 1, 0, '0000-00-00 00:00:00', 1, 1, '{"target":"","width":"","height":"","count_clicks":""}', '*', '2011-01-01 00:00:01', 867, 'Joomla', '0000-00-00 00:00:00', 0, '', '', '', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, ''),
	(2, 8, 'Joomla! Leadership Blog', 'joomla-leadership-blog', 'http://community.joomla.org/blogs/leadership.html', '', 0, 1, 0, '0000-00-00 00:00:00', 2, 1, '{"target":"","width":"","height":"","count_clicks":""}', '*', '2011-01-01 00:00:01', 867, 'Joomla', '0000-00-00 00:00:00', 0, '', '', '', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, '');
/*!40000 ALTER TABLE `zro8d_weblinks` ENABLE KEYS */;
